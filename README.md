...
### 1. **[Mobile Controlled Car](https://github.com/yourusername/Mobile-Controlled-Car)**
   ...
   - **Project Repository**: [Mobile Controlled Car Repository](https://github.com/yourusername/Mobile-Controlled-Car)

### 2. **[Certification](https://github.com/yourusername/Certification)**
   ...
   - **Tools Used**: MATLAB.
   - **Project Repository**: [MATLAB Certification Repository](./certifications/MATLAB_Certificate.pdf)

### 3. **[Simulation of Level 1 Rocket](https://github.com/yourusername/Simulation-of-level-1-rocket)**
   ...
   - **Project Repository**: [Simulation of Level 1 Rocket Repository](https://github.com/yourusername/Simulation-of-level-1-rocket)
...
### 4. **[Obstacle Avoiding Car](https://github.com/yourusername/Obstacle-Avoiding-Car)**
   ...
   - **Project Repository**: [Obstacle Avoiding Car Repository](https://github.com/yourusername/Obstacle-Avoiding-Car)

### 5. **[Radar Using Arduino](https://github.com/yourusername/Radar_Using_Arduino)**
   ...
   - **Project Repository**: [Radar Using Arduino Repository](https://github.com/yourusername/Radar_Using_Arduino)

### 6. **[Wireless Power Transmission](https://github.com/yourusername/Wireless_Power_Transmission)**
   ...
   - **Project Repository**: [Wireless Power Transmission Repository](https://github.com/yourusername/Wireless_Power_Transmission)

### 7. **[Rocket Thrust Measurement](https://github.com/yourusername/Rocket_Thrust_Measurement)**
   ...
   - **Project Repository**: [Rocket Thrust Measurement Repository](https://github.com/yourusername/Rocket_Thrust_Measurement)
...
## Contact:
Feel free to reach out to me via [LinkedIn](https://www.linkedin.com/in/yourprofile) for more information or collaborations.
